...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/fonts/flaticon/font/flaticon.css" />
					...
					<div class="property-item mb-30">
						<a href="#" class="img"> <img
							...
							<div class="property-content">
								<div>
									<span class="city d-block mb-3">봉사 구인 게시글</span></a> <span
							class="d-block mb-2 text-black-50">박해준&nbsp;&nbsp;2023-06-20</span>
					</div>
				</div>
			</div>
			<!-- .item -->
